...
{
    $formular = $store["OPWIRE_SETTINGS"]["TPBank_VTC_DSAF_HDDV_F3M"];
    return $formular;
}
...
function calcMonthlyCommision($store)
{
    ...
    $commission  = 0;
    $commission += $condition['unitNoInsuarance'] * $totalNoInsuaranceContract;
    $commission += $condition['unitInsuarance'] * $totalInsuaranceContract;
    $commission += $condition['unitGrayInsuarance'] * $totalInsuaranceGreyContract;
    $commission += $condition['unitGrayNoInsuarance'] * $totalNoInsuaranceGreyContract;
